...
class PosEstPlotter:
    def __init__(self, max_data_points=4000):
        ...
        # 订阅ROS话题
        self.subscriber1 = rospy.Subscriber('/vrpn_client_node/iris3/pose', PoseStamped, self.pose_callback)
        ...
        self.subscriber4 = rospy.Subscriber('/rkf_py/pose', PoseStamped, self.pose_callback_rkf)
