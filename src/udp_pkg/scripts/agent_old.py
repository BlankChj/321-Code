...
class Agent:
    def __init__(self, num, ids, server_host_list):
        ...
        self.pose_sub = rospy.Subscriber('/vrpn_client_node/iris6/pose', PoseStamped, self.pose_callback, queue_size=10)
