...
class RealTime3DPlotter:
    def __init__(self, max_data_points=4000):
        ...
        # 订阅ROS话题
        self.subscriber1 = message_filters.Subscriber('/vrpn_client_node/iris6/pose', PoseStamped)

        self.subscriber2 = message_filters.Subscriber('/rkf_py/pose', PoseStamped)
